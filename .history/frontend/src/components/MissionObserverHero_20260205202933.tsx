        ...
        <div className="relative h-screen w-full overflow-hidden bg-[#0a0c10] text-[#00ff41] font-sans selection:bg-emerald-500/30">
            ...
            {videoError && (
                <div
                    ...
                    style={{ backgroundImage: 'url(/bg-drone-v2.png)' }}
                />
            )}
            ...
            <div className="absolute inset-0 z-10 p-2 md:p-4 flex flex-col h-full pointer-events-none">
                ...
                {/* --- DESKTOP HEADER --- */}
                <header className="hidden md:flex flex-shrink-0 justify-between items-start pointer-events-auto min-h-[80px] relative z-[200]">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-3 mt-2">
                        <img
                            src="/logo.png"
                            alt="Mission Launchpad"
                            className="w-20 h-20 lg:w-24 lg:h-24 object-contain drop-shadow-[0_0_10px_rgba(0,255,65,0.5)]"
                        />
                        <div className="font-mono hidden lg:block">
                            <div className="text-[#00ff41] text-lg font-bold tracking-wider">MISSION</div>
                            <div className="text-[#00ff41]/70 text-sm tracking-widest">LAUNCHPAD</div>
                        </div>
                    </div>
