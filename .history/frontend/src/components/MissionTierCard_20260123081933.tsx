...
export const MissionTierCard: React.FC<MissionTierCardProps> = ({
    ...
    return (
        <div className="group cursor-pointer flex flex-col items-center h-full">
            ...
            <div
                className={`
                    w-full h-full flex flex-col bg-[#0a0c10]/90 border p-3 md:p-4 rounded-xl 
            ...
            >
                ...
                {/* Lock Duration Info - hidden on mobile */}
