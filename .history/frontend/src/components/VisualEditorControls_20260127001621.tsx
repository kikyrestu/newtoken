...
import { Ruler, Type, Settings2, X, Eye, EyeOff, Edit3, LogOut } from 'lucide-react';
            ...
            `}>
                ...
                <div className="px-4 py-2 border-t border-zinc-800 bg-zinc-900/50 rounded-b-xl">
                    <div className="flex items-center justify-between gap-2 text-xs text-zinc-500">
                        ...
                        <button
                            onClick={adminLogout}
                            className="flex items-center gap-1 px-2 py-1 text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded transition-colors"
                            title="Logout Admin"
                        >
                            <LogOut size={12} />
                            <span>Logout</span>
