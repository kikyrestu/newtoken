        ...
        >
            ...
            >
                ...
                <div className="absolute top-3 right-3">
                    <span className={`
                        text-[10px] px-2 py-1 rounded border font-bold uppercase tracking-wider
                ...
                <div>
                    ...
                    <div className="flex items-baseline gap-2">
                        {tierPricing && tierPricing.discount_percent > 0 ? (
                            <>
                                <span className="text-xs line-through text-gray-600">${tierPricing.original_price}</span>
                                <span className="text-2xl font-bold text-[#00ff41]">${tierPricing.current_price}</span>
                            </>
                        ) : (
                            <span className="text-2xl font-bold text-[#00ff41]">${tierPricing?.usd ?? tierInfo.usd}</span>
                        )}
                    </div>
                </div>
