        ...
        <div className="relative h-screen w-full overflow-hidden bg-[#0a0c10] text-[#4fffa0] font-sans selection:bg-emerald-500/30">
            ...
            <div className="absolute inset-0 z-10 p-2 md:p-4 flex flex-col h-full pointer-events-none">
                ...
                {showDashboard ? (
                    ...
                    <main className="flex-1 flex flex-col justify-center items-center gap-1 md:gap-4 min-h-0">
                        {/* CENTER: TIMER */}
                        <div className="flex-shrink-0 flex items-center justify-center px-4 w-full">
                            <div className="relative w-full max-w-sm md:max-w-lg lg:max-w-2xl flex justify-center items-center">
