                        ...
                        <div className="flex-shrink-0 flex items-center justify-center px-4">
                            <div className="relative w-full max-w-lg md:max-w-2xl lg:max-w-3xl flex justify-center items-center">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center pt-2">
                                    ...
                                    <div className="w-[68%] h-[38%] relative flex items-center justify-center">
                                        {/* Screen Scanlines - very subtle inside the glass */}
                                        <div className="absolute inset-0 bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(0,255,0,0.03)_3px)] pointer-events-none z-0 rounded-lg" />

                                        {/* Countdown Timer Component */}
                                        <div className="relative z-10 w-full flex justify-center -mt-0.5">
                                            <CountdownTimer
