...
import { Shield, History, Radio, Layout, Camera, Terminal, Gamepad2, ChevronDown, ChevronUp, Info, Zap, Users, Clock, Trophy, Target } from 'lucide-react';
                ...
                <div className="flex-1 overflow-y-auto bg-black/10 p-6 relative custom-scrollbar">
                    ...
                    {topTab === 'live' && (
                        <div className="h-full flex flex-col gap-6">
                            {/* Camera Symbol Section */}
                            <div className="flex items-center gap-4 border-b border-[#00ff41]/20 pb-4">
                                <Camera className="w-8 h-8 text-[#00ff41]" />
                                <div>
                                    <h4 className="text-sm font-bold text-white uppercase tracking-wider">(Camera Symbol)</h4>
                                    <p className="text-xs text-gray-500">Live drone camera feeds will appear here</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h4 className="text-sm font-bold text-white uppercase tracking-wider">Commands</h4>
                                </div>
                                <div className="bg-black/40 border border-[#00ff41]/20 rounded-lg p-4">
                                    <p className="text-xs text-gray-500 font-mono">// Awaiting mission start...</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h4 className="text-sm font-bold text-white uppercase tracking-wider">Controls</h4>
                                </div>
                                <button
                                    className="px-6 py-3 bg-transparent border-2 border-[#00ff41] text-[#00ff41] font-bold text-sm uppercase tracking-wider rounded hover:bg-[#00ff41] hover:text-black transition-all flex items-center gap-2"
                                >
                                    Mission Access
                                </button>
                            </div>
                            ...
                            <div className="flex-1 flex items-center justify-center border border-dashed border-[#00ff41]/30 rounded-lg bg-black/40">
                                <div className="text-center">
                                    <Radio className="w-12 h-12 text-[#00ff41] mx-auto mb-4 animate-pulse" />
