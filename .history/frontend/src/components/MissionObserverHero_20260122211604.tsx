                        ...
                        <div className="flex-shrink-0 flex items-center justify-center px-4">
                            <div className="relative w-full max-w-lg md:max-w-2xl lg:max-w-3xl flex justify-center items-center">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    {/* Removed dark bg and borders to let frame show through */}
                                    <div className="w-[68%] h-[45%] relative overflow-hidden flex items-center justify-center -translate-y-2">
                                        {/* Screen Scanlines - lighter effect */}
                                        <div className="absolute inset-0 bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(0,255,0,0.03)_3px)] pointer-events-none z-0" />
