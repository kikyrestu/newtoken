                    ...
                    <main className="flex-1 flex flex-col justify-start min-h-0 pointer-events-auto">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center px-4 pointer-events-none z-[5]">
                            {!showSafetyModal ? (
                                ...
                                />
                                {/* WARFARE TABLET MODAL */}
                            <div className="warfare-modal w-full max-w-xl transition-all duration-500 pointer-events-auto relative">
                                {/* Outer Frame - Military Tablet */}
                                <div className="relative bg-black/70 backdrop-blur-xl border-2 border-[#00ff41]/60 rounded-lg overflow-hidden diagnostic-container"
