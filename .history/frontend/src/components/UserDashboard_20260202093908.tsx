                            ...
                            {sideTab === 'missions' && (
                                <div className="space-y-2">
                                    ...
                                    <div className="text-[10px] text-gray-400 font-mono mb-3">
                                        Mission Title / Difficulty / Rewards / Mission Points / Participants / Start in
                                    </div>

                                    {/* Data Rows */}
                                    {MISSIONS_DATA.map((mission, idx) => (
                                        <div key={idx} className="text-xs text-white font-mono leading-relaxed">
                                            {mission.title} / {mission.difficulty} / {mission.rewards} / {' '}
                                            <span className="text-blue-400">{mission.missionPoints.split(' - ')[0] || mission.missionPoints}</span>
                                            ...
                                            {' '}/ {mission.participants} / {mission.startIn}
                                        </div>
                                    ))}
                                </div>
                            )}
