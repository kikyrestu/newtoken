...
const MissionObserverHero = () => {
    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-[#0a0c10] text-[#00ff41] font-sans selection:bg-emerald-500/30">
            ...
            {/* Vignette Overlay for Depth & Device Focus */}
            <div className="vignette-overlay device-focus-vignette" />
            ...
            <div className="absolute inset-0 z-10 p-2 md:p-4 flex flex-col h-full pointer-events-none">
                ...
                <header className="flex-shrink-0 flex justify-between items-start pointer-events-auto min-h-[60px] md:min-h-[80px]">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* Wallet Button */}
                        <WalletMultiButton className="tactical-btn !px-4 md:!px-8 !py-2 md:!py-3 !text-xs md:!text-sm !rounded-none" />
                    </div>
                </header>
                ...
                {showDashboard ? (
                    ...
                    <main className="flex-1 flex flex-col min-h-0 pointer-events-auto">
                        ...
                        {/* CENTER DISPLAY AREA - Scaled 2.5x with improved spacing */}
                        <div className="flex-1 flex items-center justify-center px-4 min-h-0 -mt-4 md:-mt-8">
                            {!showSafetyModal ? (
                                <div className="w-full flex items-center justify-center py-4">
                                    {/* Device Wrapper with 2.5x Scale */}
                                    <div className="relative transform scale-[1.8] md:scale-[2.2] lg:scale-[2.5] origin-center">
                                        {/* Ambient Glow Behind Device */}
                                        <div className="device-ambient-glow" />

                                        {/* Device Frame with Enhanced Glow */}
                                        <div className="relative inline-block">
                                            <img
                                                src="/assets/timer-countdown.png"
                                                alt="Countdown Frame"
                                                className="h-[140px] md:h-[160px] lg:h-[180px] w-auto object-contain select-none pointer-events-none device-frame-glow"
                                            />

                                            {/* Timer container - BEHIND the frame with intense glow */}
                                            <div className="absolute top-[34%] bottom-[30%] left-[15%] right-[15%] flex items-center justify-center z-[-1]">
                                                {/* Moving Scanline Effect */}
                                                <div className="device-scanline" />
                                                ...
                                                <CountdownTimer
                                                    ...
                                                    showStatus={false}
                                                    variant="device"
                                                    className="w-full h-full flex items-center justify-center neon-glow-intense neon-pulse"
                                                />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {/* --- BOTTOM: MISSION CARDS - Pulled up closer to device --- */}
                        <div className="flex-shrink-0 w-full px-2 md:px-6 pb-4 -mt-8 md:-mt-12 lg:-mt-16">
