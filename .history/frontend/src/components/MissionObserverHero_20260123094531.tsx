            ...
            {showDashboard ? (
                ...
                <div className="relative z-20 w-full h-full px-4 md:px-8 py-4 flex flex-col justify-between">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center z-0">
                        <div className="relative w-[42%] h-[16%] bg-[#051505]/60 border border-[#4fffa0]/10 rounded-sm shadow-[inset_0_0_15px_rgba(79,255,160,0.1)] overflow-hidden">
                    ...
                    <img
                        ...
                        alt="Timer Frame"
                        className="relative z-10 w-full max-h-[50vh] object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.9)]"
                    />

                    {/* Digital Numbers - Top Layer */}
                    <div className="absolute inset-0 flex items-center justify-center z-20">
                        <div className="w-[42%] h-[16%] relative flex items-center justify-center overflow-hidden">
                            <CountdownTimer
                                unlockTimestamp={unlockTimestamp}
                                size="lg"
                                showLabels={false}
                                showStatus={false}
                                className="w-full h-full flex flex-col items-center justify-center overflow-hidden scale-60 md:scale-75"
                            />
                        </div>
                    </div>
