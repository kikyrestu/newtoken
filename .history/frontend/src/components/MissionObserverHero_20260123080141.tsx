                        ...
                        <div className="flex-shrink-0 flex items-center justify-center px-4">
                            <div className="relative w-full max-w-lg md:max-w-2xl lg:max-w-3xl flex justify-center items-center">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    {/* Inner container with dark background for visibility */}
                                    <div className="w-[70%] h-[42%] relative flex items-center justify-center bg-black/60 rounded-md border border-[#4fffa0]/20">
                                        {/* Screen Scanlines */}
