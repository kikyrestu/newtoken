...
import { useStaking, StakingTier, StakeInfo } from '../hooks/useStaking';
import { Clock, Gift, Lock, ChevronRight, AlertCircle, CheckCircle } from 'lucide-react';
...
const StakeForm: React.FC<StakeFormProps> = ({ tier, onClose }) => {
    ...
    const { calculateReward, stake } = useStaking();
