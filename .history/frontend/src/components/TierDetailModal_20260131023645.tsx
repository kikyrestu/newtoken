...
import { X, AlertCircle, Shield, Eye, Gift, ChevronRight, Home, Loader2, CheckCircle } from 'lucide-react';
...
const TIER_CONTENT = {
    spectator: {
        ...
        tagline: 'Watch the Mission',
        features: [
            'Select and monitor active drones in real time',
            'Access the live drone camera during operations'
        ],
        rewards: ['3% Cashback', 'Mission Points'],
        maxSlots: 1000,
        cta: 'Secure your Limited Observer Slot now!'
    },
    operator: {
        displayName: 'Recon Drone Operator',
        tagline: 'Seek. Identify. Tag.',
        features: [
            'Full Observer access plus control features',
            'Tag and mark targets for the team',
            'Enhanced reconnaissance capabilities'
        ],
        rewards: ['5% Cashback', 'Mission Points', 'Priority Support'],
        maxSlots: 700,
        cta: 'Claim your Recon Drone Operator position!'
    },
    elite: {
        displayName: 'Advanced Drone Operator',
        tagline: 'Seek. Identify. Execute.',
        features: [
            'Full Operator access plus advanced controls',
            'Execute mission-critical operations',
            'Maximum rewards and priority access'
        ],
        rewards: ['10% Cashback', 'Double Mission Points', 'VIP Access'],
        maxSlots: 300,
        cta: 'Secure your Elite Advanced Operator Slot!'
    }
};
                ...
                {step === 'details' && (
                    <div className="p-6">
                        ...
                        <div className="mb-4 p-3 bg-yellow-500/5 border border-yellow-500/20 rounded-lg">
                            <h4 className="text-sm font-bold text-white mb-2">Early Access</h4>
                            <p className="text-xs text-gray-400 mb-2">Be among the first to join and save:</p>
                            <div className="text-sm">
                                <div className="text-green-400">- First 200 users: -20%</div>
                                <div className="text-yellow-400">- Next 200 users: -10%</div>
                            </div>
                        </div>
