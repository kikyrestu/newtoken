            ...
            {showDashboard ? (
                ...
                <div className="relative z-20 w-full h-full px-4 md:px-8 py-4 flex flex-col justify-between">
                    ...
                    <div className="flex-grow flex items-center justify-center relative py-2">
                        <div className="relative w-full max-w-lg md:max-w-4xl lg:max-w-6xl flex justify-center items-center">
                            {/* Night Vision Background - Behind Frame */}
                            <div className="absolute inset-0 flex items-center justify-center pt-2 z-0">
                                <div className="w-[50%] h-[24%] bg-[#051505]/60 border border-[#4fffa0]/10 rounded-md shadow-[inset_0_0_15px_rgba(79,255,160,0.1)]">
