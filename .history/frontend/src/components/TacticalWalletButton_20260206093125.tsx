...
export const TacticalWalletButton: React.FC = () => {
    const { connected, publicKey, disconnect, connecting, wallet, wallets, select } = useWallet();
    ...
    const handleClick = () => {
        ...
        if (connected) {
            ...
            setVisible(true);
            console.log('[TacticalWalletButton] setVisible(true) called, modal should open');
        }
    };
