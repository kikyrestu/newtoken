    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-[#0a0c10] text-[#00ff41] font-sans selection:bg-emerald-500/30">
            ...
            <div className="absolute inset-0 z-10 p-2 md:p-4 flex flex-col h-full pointer-events-none">
                ...
                {/* --- TOP NAV BAR --- */}
                <header className="flex-shrink-0 flex justify-between items-start pointer-events-auto min-h-[50px] md:min-h-[80px]">
                    {/* Top Left Stats - Telemetry Widget (hidden on small mobile) */}
                    <div className="hidden sm:block scale-75 origin-top-left md:scale-90 lg:scale-100">
                        <TelemetryWidget
                    ...
                    {/* Mobile: Simple logo/text */}
                    <div className="sm:hidden flex items-center gap-2 text-[#00ff41] font-mono text-xs">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
                        ...
                        {connected && (
                            <button
                                ...
                                className={`text-white font-bold text-[10px] sm:text-xs md:text-base hover:text-[#00ff41] transition-colors px-1 sm:px-2 py-1 ${showDashboard ? 'text-[#00ff41]' : ''}`}
                            >
                        ...
                        <button
                            ...
                            className="text-white font-bold text-[10px] sm:text-xs md:text-base hover:text-[#00ff41] transition-colors px-1 sm:px-2 py-1"
                        >
                            Swap
                        </button>
                ...
                {showDashboard ? (
                    ...
                    <main className="flex-1 flex flex-col justify-start min-h-0 pointer-events-auto">
                        ...
                        {/* --- BOTTOM: MISSION CARDS - Hidden on mobile (use MobileCardCarousel instead) --- */}
                        <div className="hidden md:block flex-shrink-0 w-full px-2 md:px-6 pb-2 pt-2 mt-auto">
            ...
            {/* Welcome Guide - Only for non-connected users */}
            {showWelcomeGuide && !connected && (
