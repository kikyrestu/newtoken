...
import { useAdminMissions, type AdminMission } from '../../hooks/useMissions';
...
export const AdminMissions: React.FC = () => {
    const { missions, loading, error, createMission, updateMission, deleteMission } = useAdminMissions();
