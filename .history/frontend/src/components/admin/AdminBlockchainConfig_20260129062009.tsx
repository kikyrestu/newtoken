...
import { useBlockchainConfig, BlockchainConfig } from '../../hooks/useBlockchainConfig';
import {
    Save,
    RotateCcw,
    Check,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-black/40 border border-[#00ff41]/10 rounded-xl p-5 lg:col-span-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        {config.price_oracle === 'manual' && (
                            <div>
                                <label className="block text-xs text-gray-500 mb-1">Manual Token Price (USD)</label>
                                <div className="relative">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">$</span>
                                    <input
                                        type="number"
                                        step="0.0000001"
                                        value={config.manual_token_price}
                                        onChange={(e) => handleChange('manual_token_price', parseFloat(e.target.value) || 0)}
                                        className="w-full pl-7 pr-3 py-2 bg-black/40 border border-[#00ff41]/20 rounded-lg text-white focus:outline-none focus:border-[#00ff41]/50"
                                    />
                                </div>
                            </div>
                        )}
