...
export const MissionTierCard: React.FC<MissionTierCardProps> = ({
    ...
    return (
        <div className="group cursor-pointer flex flex-col items-center">
            ...
            <div
                className={`
                    w-full bg-[#0a0c10]/90 border p-2 md:p-3 rounded-lg 
            ...
            >
                ...
                {/* Content */}
                <h3 className="text-white font-bold text-sm md:text-base mb-1 pr-20">
                    {title}
                    <span className="text-[#4fffa0] ml-2">${tierPricing?.usd || tierInfo.usd}</span>
                </h3>

                <p className="text-[10px] md:text-xs text-gray-400 leading-tight mb-1 line-clamp-2">
                    {description}
                </p>

                {/* Token Amount */}
                {tierPricing && isPriceAvailable(tier) && (
                    <div className="text-[10px] text-[#4fffa0]/70 mb-2 flex items-center gap-1">
                ...
                <button
                    ...
                    className={`
                        w-full py-1.5 px-2 rounded-md font-bold text-xs transition-all duration-300
