            ...
            <div className="absolute inset-0 z-10 p-2 md:p-4 flex flex-col h-full pointer-events-none">
                ...
                {showDashboard ? (
                    ...
                    <main className="flex-1 flex flex-col min-h-0 pointer-events-auto">
                        ...
                        {/* CENTER DISPLAY AREA - Timer positioned higher */}
                        <div className="flex-1 flex items-start justify-center px-4 min-h-0 pt-4 md:pt-8">
                            {!showSafetyModal ? (
                                <div className="w-full max-w-xl h-[200px] md:h-[260px] lg:h-[300px] flex items-center justify-center">
