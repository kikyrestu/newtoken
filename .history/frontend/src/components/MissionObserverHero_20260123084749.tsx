            ...
            {showDashboard ? (
                ...
                <div className="relative z-20 w-full h-full px-4 md:px-8 py-4 flex flex-col justify-between">
                    ...
                    <div className="flex-grow flex items-center justify-center relative py-2">
                        <div className="relative w-full max-w-lg md:max-w-3xl lg:max-w-5xl flex justify-center items-center">
                            ...
                            <img
                                ...
                                alt="Timer Frame"
                                className="relative z-10 w-full max-h-[40vh] object-contain drop-shadow-[0_20px_50px_rgba(0,0,0,0.9)]"
                            />
