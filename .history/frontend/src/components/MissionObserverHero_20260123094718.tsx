        ...
        <div className="relative h-screen w-full overflow-hidden bg-[#0a0c10] text-[#4fffa0] font-sans selection:bg-emerald-500/30">
            ...
            {showDashboard ? (
                ...
                <div className="relative z-20 w-full h-full px-4 md:px-8 py-4 flex flex-col justify-between">
                    ...
                    {/* --- CENTER: TIMER (Refactored for Alignment) --- */}
                    <div className="relative z-10 flex-grow flex items-center justify-center py-4">
                        {/* Container that hugs the image size */}
                        <div className="relative w-full max-w-3xl aspect-[21/9] flex items-center justify-center">

                            {/* Night Vision Background - Scaled to fit strictly inside the frame window */}
                            <div className="absolute inset-x-[15%] inset-y-[18%] bg-[#051505]/80 border border-[#4fffa0]/10 rounded-sm shadow-[inset_0_0_20px_rgba(79,255,160,0.2)] overflow-hidden z-0">
                            ...
                            {/* Timer Frame Image - Drives the layout */}
                            <img
                                src="/time-countdown.png"
                                alt="Timer Frame"
                                className="relative z-10 w-full h-full object-contain drop-shadow-[0_10px_30px_rgba(0,0,0,0.8)]"
                            />

                            {/* Digital Numbers - Centered exactly in the frame */}
