            ...
            <div className="absolute inset-0 z-10 p-2 md:p-4 flex flex-col h-full pointer-events-none">
                ...
                {showDashboard ? (
                    ...
                    <main className="flex-1 flex flex-col justify-start min-h-0 pointer-events-auto">
                        ...
                        {/* CENTER DISPLAY AREA - Timer positioned at top with negative margin to compensate for tall header */}
                        <div className="flex-shrink-0 w-full flex justify-center px-4 pt-4 md:pt-8 -mt-32 md:-mt-40">
                            {!showSafetyModal ? (
                                <div className="w-full max-w-xl h-[200px] md:h-[260px] lg:h-[300px]">
