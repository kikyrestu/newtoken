                    ...
                    <main className="flex-1 flex flex-col justify-start min-h-0 pointer-events-auto">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center px-4 pointer-events-none z-[5]">
                            {!showSafetyModal ? (
                                ...
                                <div className="w-full max-w-xl transition-all duration-500 pointer-events-auto">
                                    {/* Styled Modal - Large Size like Reference */}
                                    <div className="relative bg-[#0a0c10]/95 border border-[#4fffa0]/60 p-6 rounded-lg 
                                        transition-all duration-300 overflow-hidden backdrop-blur-md
                                        shadow-[0_0_40px_rgba(79,255,160,0.3)]">
                                        ...
                                        {/* Content - Protocol List with Full Details */}
                                        <div className="space-y-4">
                                            {[
                                                {
                                                    title: "Altitude Enforcement",
                                                    desc: "Drone automatically climbs to its assigned altitude. Height adjustments allowed only within safe limits."
                                                },
                                                {
                                                    title: "Geo-Fence Active",
                                                    desc: "Flight area strictly defined — operation outside the zone is blocked."
                                                },
                                                {
                                                    title: "Anti-Collision / Swarm Separation",
                                                    desc: "Active system prevents contact with other drones or obstacles + crash prevention.",
                                                    badge: "Active"
                                                },
                                                {
                                                    title: "Signal Loss Response",
                                                    desc: "Auto-hover, stabilization, RTB (Return to Base)."
                                                },
                                                {
                                                    title: "Continuous Monitoring",
                                                    desc: "Live telemetry + full mission logging for audit/replay."
                                                },
                                                {
                                                    title: "Certified Operator Oversight",
                                                    desc: "All missions supervised by trained operators."
                                                }
                                            ].map((item, index) => (
                                                <div key={index} className="flex items-start gap-3">
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            {item.badge && (
                                                                <span className="text-[10px] px-2 py-0.5 rounded bg-[#4fffa0]/20 text-[#4fffa0] font-medium">
                                                                    {item.badge}
                                                                </span>
                                                            )}
                                                        </div>
