                        ...
                        <div className="flex-shrink-0 flex items-center justify-center px-4">
                            <div className="relative w-full max-w-lg md:max-w-2xl lg:max-w-3xl flex justify-center items-center">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center pt-2">
                                    ...
                                    <div className="w-[58%] h-[28%] relative flex items-center justify-center bg-[#051505]/60 border border-[#4fffa0]/10 rounded-md shadow-[inset_0_0_15px_rgba(79,255,160,0.1)]">
                                        {/* DEBUG RULERS - TEMPORARY */}
                                        <div className="absolute w-full h-[1px] bg-red-500/50 top-1/2 left-0 z-50 pointer-events-none" />
                                        <div className="absolute w-[1px] h-full bg-red-500/50 top-0 left-1/2 z-50 pointer-events-none" />
