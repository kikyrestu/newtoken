...
const MissionObserverHero = () => {
    ...
    const [fontSize, setFontSize] = useState(24); // Font size in pixels
                                        ...
                                        {debugMode && (
                                            <div className="absolute -bottom-48 left-1/2 -translate-x-1/2 bg-black/95 border border-green-500 rounded-lg p-4 pointer-events-auto z-[100] min-w-[400px]">
                                                ...
                                                <div className="grid grid-cols-4 gap-2 mb-3">
                                                    ...
                                                    {/* FONT SIZE */}
                                                    <div className="col-span-4 flex items-center justify-center gap-2 mt-2 pt-2 border-t border-gray-700">
                                                        <span className="text-purple-400 font-mono text-xs w-16">FONT:</span>
                                                        <button onClick={() => setFontSize(s => Math.max(8, s - 2))} className="bg-purple-600 hover:bg-purple-500 text-white px-2 py-1 rounded text-xs">- 2px</button>
                                                        <span className="text-white font-mono text-sm w-16 text-center">{fontSize}px</span>
                                                        <button onClick={() => setFontSize(s => s + 2)} className="bg-purple-600 hover:bg-purple-500 text-white px-2 py-1 rounded text-xs">+ 2px</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="bg-gray-900 p-2 rounded border border-gray-700 font-mono text-xs">
                                                    ...
                                                    <code className="text-cyan-400 select-all block">
                                                        top-[{timerPos.top}%] bottom-[{timerPos.bottom}%] left-[{timerPos.left}%] right-[{timerPos.right}%]
                                                    </code>
                                                    <code className="text-purple-400 select-all block mt-1">
