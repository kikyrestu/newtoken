            ...
            <div className="absolute inset-0 z-10 p-2 md:p-4 flex flex-col h-full pointer-events-none">
                ...
                {showDashboard ? (
                    ...
                    <main className="flex-1 flex flex-col justify-center items-center gap-1 md:gap-4 min-h-0 pointer-events-auto">
                        ...
                        <div className="flex-shrink-0 flex items-center justify-center px-4 w-full mb-2 md:mb-4">
                            {!showSafetyModal ? (
                                <div className="w-full max-w-xl h-[280px] md:h-[350px] lg:h-[400px] flex items-center justify-center">
                                    <div className="relative inline-block h-full w-auto max-w-full">
                                        ...
                                        {/* Timer container - FINAL POSITION */}
                                        <div className="absolute top-[34%] bottom-[30%] left-[15%] right-[15%] flex items-center justify-center">
                                            <CountdownTimer
