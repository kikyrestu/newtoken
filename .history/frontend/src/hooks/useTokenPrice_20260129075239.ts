...
export function useTokenPrice() {
    ...
    const fetchPricing = useCallback(async () => {
        try {
            ...
            setPricing({
                spectator: { usd: 25, tokens: 0, tokens_formatted: 'N/A', token_price: 0, error: 'Price unavailable', current_price: 25, original_price: 25, discount_percent: 0, remaining_slots_in_tier: null, next_price: 25, locked_count: 0 },
                operator: { usd: 150, tokens: 0, tokens_formatted: 'N/A', token_price: 0, error: 'Price unavailable', current_price: 150, original_price: 150, discount_percent: 0, remaining_slots_in_tier: null, next_price: 150, locked_count: 0 },
                elite: { usd: 250, tokens: 0, tokens_formatted: 'N/A', token_price: 0, error: 'Price unavailable', current_price: 250, original_price: 250, discount_percent: 0, remaining_slots_in_tier: null, next_price: 250, locked_count: 0 }
            });
        } finally {
            setLoading(false);
        }
